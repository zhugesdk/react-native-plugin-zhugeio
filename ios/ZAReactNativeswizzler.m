//
//  NSObject+ZAReactNativeswizzler.m
...
@implementation NSObject (ZAReactNativeswizzler)
...
+ (BOOL)za_reactnative_swizzleClassMethod:(SEL)origSel_ withClassMethod:(SEL)altSel_ error:(NSError **)error_ {
    return [GetClass((id)self) za_reactnative_swizzleMethod:origSel_ withMethod:altSel_ error:error_];
}
